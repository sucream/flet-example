from gui.appbar import app_bar
from gui.views.index import MainView
from gui.components.FormContainer import FormContainer
from gui.automation import crud
...
def main(page: ft.Page):
    ...
    def add_category(e):
        ...
        try:
            new_category = crud.create_new_category(main_section_ref.current.value, sub_section_ref.current.value, category_name_ref.current.value)
